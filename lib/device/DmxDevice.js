import DmxParam from '../param/DmxParam';
...
export default class DmxDevice {
   ...
   * @param {Number} startAddress this is the DMX-Adress (1-based) of the
   *   first dmx-channel of this device.
   * @param {Object.<String, DmxParam>} params The parameters of this device.
   */
  constructor(startAddress, params) {
    /**
     * @private {Number}
     */
    this.bufferOffset = startAddress - 1;
